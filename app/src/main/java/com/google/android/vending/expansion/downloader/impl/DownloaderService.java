...
public abstract class DownloaderService extends CustomIntentService implements IDownloaderService {
    ...
    void pollNetworkState() {
        if (null == mConnectivityManager) {
            // KEL TEST mConnectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
            mConnectivityManager = (ConnectivityManager) getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        }
        if (null == mWifiManager) {
            // KEL TEST mWifiManager = (WifiManager) getSystemService(Context.WIFI_SERVICE);
