...
// KEL TEST import com.android.vending.expansion.downloader.R;
import com.kelth.myapkexpansion.R;
...
public class DownloadNotification implements IDownloaderClient {
    ...
    private Notification.Builder mNotificationBuilder; // KEL
    private Notification.Builder mCurrentNotificationBuilder; // KEL
    ...
    public void onDownloadStateChanged(int newState) {
        ...
        if (newState != mState) {
            ...
            if (ongoingEvent) {
                mCurrentNotificationBuilder.setOngoing(true);
            } else {
                mCurrentNotificationBuilder.setOngoing(false);
                mCurrentNotificationBuilder.setAutoCancel(true);
            }
            mCurrentNotificationBuilder.build();
            mCurrentNotification = mCurrentNotificationBuilder.getNotification();
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            mNotificationBuilder.setTicker(mCurrentText);
